...
Instead a semi global approach is used, a compromise between the two methods. 
...
The flowchart of the complete system as described in the original article \cite{•} can be seen in figure \ref{fig:complete_system}.
